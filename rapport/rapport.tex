...
L'utilisateur peut intéragir avec l'application via :

\begin{itemize}
    \item Sur la page via des \textbf{boutons} et des \textbf{formulaires},
    \item Les \textbf{deux boutons} de thème et de langue disponible sur le côté droit de la \textbf{barre horizontale} en haut de l'écran,
    \item Le \textbf{bouton d'action} en bas à droite de l'écran.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Admin :} permet aux adminstrateur de gérer les comptes.
\end{itemize}

\textbf{Accedez au compte adminstrateur :}

\begin{itemize}
	\item login : \texttt{admin}
	\item mot de passe : \texttt{admin}
\end{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{img/signin_light.png}
    \caption{Thème clair de la page de connection}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{img/signin.png}
    \caption{Thème sombre de la page de connection}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{img/profile_light.png}
    \caption{Utilisateur consultant son profil avec le thème clair}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{img/admin_light.png}
    \caption{Thème clair de la page d'adminisatration}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{img/admin_dark.png}
    \caption{Utilisateur en train de créer un nouvelle utilisateur via la page admin}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{img/home_mobile.png}
    \caption{Utilisateur non connecté sur mobile consultant les publication avec le thème sombre}
\end{figure}
