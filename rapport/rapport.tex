...
\begin{itemize}
    \item Sur la page via des icones ou des boutons,
    \item Les deux boutons de thème et de langue disponible sur le côté gauche de la barre horizontale en haut de l'écran,
    \item Le bouton d'action en bas à gauche de l'écran.
\end{itemize}
